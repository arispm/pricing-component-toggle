...
const Container = () => {
  return (
    <>
      <div className="text-[#494c5f] font-work-sans h-[94vh] bg-no-repeat bg-left-bottom sm:bg-svg-bottom bg-[#f6f6fe]">
        <svg xmlns="http://www.w3.org/2000/svg" width="375" height="658" class="absolute top-0 right-0 h-full">
        ...
        <Toggle />
        <Card />
        <svg xmlns="http://www.w3.org/2000/svg" width="353" height="304" class="h-1/2">
          <g fill="none" fill-rule="evenodd" stroke="#D0D5F6" stroke-width="2">
